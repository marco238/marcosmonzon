...
`},function(e,t,n){e.exports=n(3)},function(e,t,n){"use strict";n.r(t);var r=n(0),i=n(1);class o extends r.a{static get styles(){return[i.a,r.b`
      ...
      <nav>
        <a href="/home" ?active="${"/marcosmonzon/home"===this.path||"/"===this.path}" @click="${()=>this._updatePath("/home")}">HOME</a>
        <a href="/work" ?active="${"/marcosmonzon/work"===this.path}" @click="${()=>this._updatePath("/work")}">WORK</a>
        <a href="/about" ?active="${"/marcosmonzon/about"===this.path}" @click="${()=>this._updatePath("/about")}">ABOUT</a>
        <a href="/contact" ?active="${"/marcosmonzon/contact"===this.path}" @click="${()=>this._updatePath("/contact")}">CONTACT</a>
      </nav>
