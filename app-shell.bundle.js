...
`},function(e,t,n){e.exports=n(3)},function(e,t,n){"use strict";n.r(t);var r=n(0),o=n(1);class i extends r.a{static get styles(){return[o.a,r.b`
      ...
      <nav>
        <a href="/marcosmonzon/home" ?active="${"/marcosmonzon/home"===this.path||"/"===this.path}" @click="${()=>this._updatePath("/home")}">HOME</a>
        <a href="/marcosmonzon/work" ?active="${"/marcosmonzon/work"===this.path}" @click="${()=>this._updatePath("/work")}">WORK</a>
        <a href="/marcosmonzon/about" ?active="${"/marcosmonzon/about"===this.path}" @click="${()=>this._updatePath("/about")}">ABOUT</a>
        <a href="/marcosmonzon/contact" ?active="${"/marcosmonzon/contact"===this.path}" @click="${()=>this._updatePath("/contact")}">CONTACT</a>
      </nav>
