...
class SocialMediaBar extends LitElement {
  ...
  render() {
    return html(_templateObject2$1(), menuIcon);
  }
...
var initRouter = node => {
  ...
  router.setRoutes([{
    ...
    path: '/work',
    component: 'work-view',
    action: () => import('./work-view-0d593dea.js')
  }, {
    path: '(.*)',
    component: 'view-404',
